...
const Footer = (props) => {
	return (
		<footer className="text-center text-gray-600 bg-gray-100 mt-28 lg:text-left">
			...
			<div className="p-6 text-center bg-gray-200">
				...
				<a className="font-semibold text-gray-600" href="https://tailwind-elements.com/">Tailwind Elements</a>
			</div>
		</footer>
	)
}
